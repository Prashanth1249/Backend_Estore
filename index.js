...
app.use(cors({
  origin: ["https://estorerguktbasar.netlify.app"],
  method: ["GET", "POST"],
  credentials: true,
}))
...
const dburl=`mongodb+srv://prshanthpottolla49an:${MongoDB_Password}@cluster1.4rmxngk.mongodb.net/?retryWrites=true&w=majority`;
